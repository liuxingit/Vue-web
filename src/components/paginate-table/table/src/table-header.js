              ...
              <tr>
              {
                this._l(columns, (column, cellIndex) =>
                  <th
                    ...
                    {
                      column.iconClass
                        ? <el-tooltip class="item" effect="dark" content={column.iconTips} placement="top">
                          <i class={'iconfont ' + column.iconClass} style="color: #97a8be; marginLeft: 5px"></i> 
                        </el-tooltip>
                        : ''
                    }
                    {
                    ...
                    {
                      column.labelTip
                        ? <span class="prompt">&nbsp;{column.labelTip}</span>
                        : ''
                    }
                    </div>
                  </th>
