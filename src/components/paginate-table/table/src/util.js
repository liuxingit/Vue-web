...
// export const paginateTableData = (dataList) => {
//   let itemArr
//   if (this.paginateDataList.length) { this.paginateDataList = [] } 
//   dataList.forEach(function(item, index) {
//     itemArr.push(item)
//     // 最后一页 index + 1 === arr.length
//     if ((index + 1) % this.paginationOption.pageSize === 0 || index + 1 === data.length) {
//         this.paginateDataList = this.paginateDataList.concat([itemArr])
//         itemArr = []
//       }
//   })
// }